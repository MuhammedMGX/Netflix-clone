...
import { Eye, EyeOff, GalleryVerticalEnd, Loader2Icon } from "lucide-react"
                    ...
                    <div className="grid gap-6">
                      ...
                      {error ? <Alert variant="destructive">
                        ...
                        <div className="grid gap-6">                           
                          ...
                          <div className="relative">
                          <Input id="password" {...register("password")} type={eye? "password": "text"} placeholder="Password" className="border-gray-500 h-13 placeholder:font-bold placeholder:text-gray-400 text-white font-bold selection:bg-white selection:text-black" />
                          {errors.password && ( <p className="text-red-500 text-xs m-0 absolute ms-2 ">⛒ {errors.password?.message}</p> )}
                          <div onClick={() => setEye(!eye)} className="absolute top-[50%] translate-y-[-50%] right-5 opacity-50 hover:opacity-70">{eye ? <Eye color="white" /> :  <EyeOff color="white" />}</div>
                          </div>

                          <div className="relative">
                          <Input id="confirmPassword" {...register("confirmPassword")} type={eye? "password": "text"} placeholder="Confirm Password"  className="border-gray-500 h-13 placeholder:font-bold placeholder:text-gray-400 text-white font-bold selection:bg-white selection:text-black"/>
