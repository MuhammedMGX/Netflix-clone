...
export function ContinueWatchingMovies({ data }: { data: dataInfo  }) {
  ...
  return (
    ...
    <div className="left-4 md:left-10 absolute translate-y-[-90%] overflow-hidden">
...
export function MovieSlides({ data , title }: { data: dataInfo , title: string }) { 
  ...
  return (
    <div className="mt-10 ps-10 lg:mt-10 w-full bg-transparent select-none" >
      ...
      <div className="embla relative">
        ...
        <button className="embla__next absolute top-[25%] right-5 z-11 bg-[rgba(0,0,0,0.5)] w-6 h-1/2 px-1 rounded-full" onClick={scrollNext}>
      ...
      {data?.results?.slice(0, 15).map((item) =>(
        ...
        <div key={item.id}  className="embla__slide rounded-xs flex flex-[0_0_50%] md:flex-[0_0_20%] rounded-3 me-2 transition  hover:delay-500 ease-in relative group hover:z-1 hover:scale-[140%] hover:translate-y-[-60%] shadow-xl">
          ...
          <div className='w-full px-2 py-2 rounded-b-sm bg-[#141414] absolute translate-y-[95%] bottom-0 opacity-0 group-hover:opacity-100 group-hover:duration-400 group-hover:delay-500 group-hover:transition-all group-hover:ease-in-out shadow-lg '>
            <div className='flex w-[95%] mx-auto p-[1%] h-[30%] aspect-[7/1] gap-x-1'>
...
export function PostersSlides({ data , title }: { data: dataInfo , title: string }) { 
  ...
  return (
    <div className="mt-10 ps-10 lg:mt-10 w-full bg-transparent" >
      <h2 className='text-white md:text-base font-semibold mb-2'>{title}</h2>
...
export function Top10SlidesMovies({ data , title }: { data: dataInfo , title: string }) { 
  ...
  return (
    <div className="mt-5 ps-10 lg:mt-10 w-full bg-transparent" >
      <h2 className='text-white md:text-base font-semibold mb-2'>{title}</h2>
      ...
      <button className="embla__next absolute top-[25%] right-5 z-11 bg-[rgba(0,0,0,0.5)] w-6 h-1/2 px-1 rounded-full" onClick={scrollNext}>
        ...
        <div className='embla__viewport overflow-hidden ' ref={emblaRef}>
          ...
          <div onClick={() => openModal(data.results[0].id)} className="embla__slide flex flex-[0_0_40%] md:flex-[0_0_20%] rounded-3">
          ...
          <div onClick={() => openModal(data.results[1].id)} className="embla__slide flex flex-[0_0_40%] md:flex-[0_0_20%] rounded-3 ">
          ...
          <div onClick={() => openModal(data.results[2].id)} className="embla__slide flex flex-[0_0_40%] md:flex-[0_0_20%] rounded-3 relative">
          ...
          <div onClick={() => openModal(data.results[3].id)} className="embla__slide flex flex-[0_0_40%] md:flex-[0_0_20%] rounded-3 relative">
          ...
          <div onClick={() => openModal(data.results[4].id)} className="embla__slide flex flex-[0_0_40%] md:flex-[0_0_20%] rounded-3 relative">
          ...
          <div onClick={() => openModal(data.results[5].id)} className="embla__slide flex flex-[0_0_40%] md:flex-[0_0_20%] rounded-3 relative">
          ...
          <div onClick={() => openModal(data.results[6].id)} className="embla__slide flex flex-[0_0_40%] md:flex-[0_0_20%] rounded-3 relative">
          ...
          <div onClick={() => openModal(data.results[7].id)} className="embla__slide flex flex-[0_0_40%] md:flex-[0_0_20%] rounded-3 relative">
          ...
          <div onClick={() => openModal(data.results[8].id)} className="embla__slide flex flex-[0_0_40%] md:flex-[0_0_20%] rounded-3 relative">
          ...
          <div onClick={() => openModal(data.results[9].id)} className="embla__slide flex flex-[0_0_40%] md:flex-[0_0_20%] rounded-3 relative ms-8">
  ...
  return (
    ...
    <div className="pt-25 w-full bg-transparent select-none" >
      ...
      {MovieData?.map((item:any) =>(
          ...
          <div key={item.id} className="embla__slide rounded-xs flex w-1/2 md:w-1/4 lg:1/5 xl-1/6 rounded-3 transition  md:hover:delay-500 ease-in relative group md:hover:z-1 md:hover:scale-[140%] md:hover:translate-y-[-60%] shadow-xl">
...
export function MobileMyListE({ MovieData , TvData , isMobile }: { MovieData: any, TvData: any , isMobile:boolean }) {
  const [selectedMovieId, setSelectedMovieId] = useState<number | null>(null);
  const [selectedTvId, setSelectedTvId] = useState<number | null>(null);
  ...
  return (
    ...
    <div className="pt-25 w-full bg-transparent select-none" >
      ...
      {MovieData?.map((item:any) =>(
        ...
        <div key={item.id} onClick={() => openModalMovie(item.id)} className="embla__slide flex flex-[0_0_30%]  me-2 rounded-3">
            {item.backdrop_path?<img className='object-cover rounded-xs' src={tmdbDropS+item.poster_path} alt="" />:<div className="flex w-full aspect-[10/5.6]"><Skeleton className=" w-full rounded-xl object-cover rounded-xs" /></div>}
          </div>
        ))}
        ...
        {TvData?.map((item:any) =>(
         ...
         <div key={item.id} onClick={() => openModalTv(item.id)} className="embla__slide flex flex-[0_0_30%]  me-2 rounded-3">
            {item.backdrop_path?<img className='object-cover rounded-xs' src={tmdbDropS+item.poster_path} alt="" />:<div className="flex w-full aspect-[10/5.6]"><Skeleton className=" w-full rounded-xl object-cover rounded-xs" /></div>}
          </div>
...
export function SearchE({ data , isMobile , titleH }: { data: any, isMobile: boolean , titleH: string }) {
  ...
  return (
    ...
    <div className="w-full bg-transparent select-none" >
      ...
      <div className="flex flex-wrap flex-row px-10 hidden lg:flex">
      {data?.results?.slice(0, 15).map((item:any) =>(


            <div key={item.id} className="embla__slide rounded-xs w-1/4 rounded-3 transition  md:hover:delay-500 ease-in relative group md:hover:z-1 md:hover:scale-[140%] md:hover:translate-y-[-60%] shadow-xl">
             <div className='p-1 md:group-hover:p-0 md:group-hover:delay-500'>

              {item.backdrop_path?<img onClick={() => openModal(item.title ? item.title : item.name , item.overview , item.backdrop_path, item.poster_path , item.release_date)} className='object-cover rounded-xs aspect-[10/5.6]' src={tmdbDropS+item.backdrop_path} alt="" />:<div onClick={() => openModal(item.title ? item.title : item.name , item.overview , item.backdrop_path, item.poster_path , item.release_date)} className="w-full aspect-[10/5.6]"><Skeleton className=" w-full h-full rounded-xl object-cover rounded-xs" /></div>}
              <p className='text-white font-semibold break-words absolute bottom-1 left-3 drop-shadow-2xl md:group-hover:translate-y-[-30%] md:group-hover:duration-400 md:group-hover:delay-500 md:group-hover:transition-all'>{item.title ? item.title : item.name}</p>
              <div className='w-full px-2 py-2 rounded-b-sm bg-[#141414] absolute translate-y-[95%] bottom-0 opacity-0 md:group-hover:opacity-100 md:group-hover:duration-400 md:group-hover:delay-500 md:group-hover:transition-all md:group-hover:ease-in-out shadow-lg '>
              <div className='flex w-[95%] mx-auto p-[1%] h-[30%] aspect-[7/1] gap-x-1'>
                <img onClick={() => openModal(item.title ? item.title : item.name , item.overview , item.backdrop_path, item.poster_path , item.release_date)} src={play.src} className='object-cover hover:opacity-50' alt="" />
      ...
      <div className="flex flex-wrap gap-y-2 px-1 md:px-10 justify-center flex lg:hidden">
      {data?.results?.slice(0, 15).map((item:any) =>(
          <div key={item.id} onClick={() => openModal(item.title ? item.title : item.name , item.overview , item.backdrop_path, item.poster_path , item.release_date)} className="embla__slide flex flex-[0_0_30%]  me-2 rounded-3">
